...
namespace Services.UI
{
    ...
    public class SnapScrollRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
            ...
            if (_showPageSelection)
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < pageSelectionIcons.childCount; i++)
                    {
                        ...
                        if (image == null) Debug.LogWarning("Page selection icon at position " + i + " is missing Image component");
        ...
        public void OnEndDrag(PointerEventData aEventData)
        {
            ...
            float difference;
            if (_horizontal) difference = _startPosition.x - _container.anchoredPosition.x;
            else difference = -(_startPosition.y - _container.anchoredPosition.y);
        ...
        public void OnDrag(PointerEventData aEventData)
        {
            ...
            {
                if (_showPageSelection) SetPageSelection(GetNearestPage());
            }
        }
    }
}
